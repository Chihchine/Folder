					            ...
					            <select class="form-control" name="newpromotion">
					              ...
					              <option value="M2">5ème année</option>
										...
										<div class="form-group col-md-12">
												<textarea class="form-control" name="pres" value="<?php echo $userinfo["PRESENTATION"] ?>" required rows="6" placeholder="Une description de vous, sur vos intérêts, vos compétences, vos projets, etc">Actuellement en école d'informatique à l'EPSI, je suis disponible et intéressé par un projet novateur, j'aime aussi la musique pourquoi pas créer un groupe ? :)</textarea>
